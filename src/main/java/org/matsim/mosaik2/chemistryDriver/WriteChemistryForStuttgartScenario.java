...
public class WriteChemistryForStuttgartScenario {
    ...
    void writeNest3() {
        ...
        var bounds = new DoubleRaster.Bounds(originX, originY, originX + 960 * cellSize, originY + 1200 * cellSize);
    ...
    void writeNest2() {
        ...
        var bounds = new DoubleRaster.Bounds(originX, originY, originX + 2400 * cellSize, originY + 2296 * cellSize);
    ...
    void writeNest1() {
     ...
     var bounds = new DoubleRaster.Bounds(originX, originY, originX + 1248 * cellSize, originY + 1232 * cellSize);
     write(bounds, cellSize, nest1OutputFile);
    }

    void write(DoubleRaster.Bounds bounds, double cellSize, String outputFileName) {
