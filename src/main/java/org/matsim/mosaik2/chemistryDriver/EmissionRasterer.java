...
public class EmissionRasterer {
    ...
    static <T> TimeBinMap<Map<T, Raster>> raster(TimeBinMap<Map<T, Map<Id<Link>, Double>>> timeBinMap, Network network, Raster.Bounds bounds, double cellSize) {

        TimeBinMap<Map<T, Raster>> rasterTimeBinMap = new TimeBinMap<>(timeBinMap.getBinSize());
