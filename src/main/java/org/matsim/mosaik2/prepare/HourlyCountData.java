...
public class HourlyCountData {
    ...
    private final Day representedDay;

    private final Map<Integer, Integer> R1Divisors;
    private final Map<Integer, Integer> R2Divisors;
    private final HashMap<Integer, Double> R1VolumesPerHour;
    private final HashMap<Integer, Double> R2VolumesPerHour;
