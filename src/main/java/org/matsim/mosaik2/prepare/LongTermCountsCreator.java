...
public class LongTermCountsCreator {
    ...
    private final Geometry filter;
    private final Map<String, String> countingStationNames = new HashMap<String, String>();
    private final Map<String, String> problemsPerCountingStation = new HashMap<String, String>();
    private final List<String> notLocatedCountingStations = new ArrayList<String>();
    int weekRange_min = 1;
    int weekRange_max = 5;
