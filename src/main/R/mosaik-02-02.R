...
ggsave(plot = p, filename = "/Users/janek/Documents/writing/mosaik-2-02/data-files-nextcloud/r-output/car-trips-berlin.pdf", width = 220, height = 118, units = "mm")
ggsave(plot = p, filename = "/Users/janek/Documents/writing/mosaik-2-02/data-files-nextcloud/r-output/car-trips-berlin.png", width = 220, height = 118, units = "mm", dpi = 300)
