...
/*
Run this class with an altered network file which doesn't have pt in it yet
the command args are as follows <path-to-config> --config:network.networkFile <path-to-altered-network>
 */
public class RunBerlinScenarioWithOriginalGeometries {
